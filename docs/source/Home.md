...
Note: In C#, interface names are typically prefixed with I. The Mod interface is therefore named IMod to follow standard convention. Hope that clears up any confusion.
