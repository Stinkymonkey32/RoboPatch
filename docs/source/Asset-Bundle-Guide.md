...
AssetBundles are Unity's format for packaging 3D models, textures, prefabs, and other assets. You can find more about them here: https://docs.unity3d.com/6000.4/Documentation/Manual/AssetBundlesIntro.html
